...
data = [
    ...
    {'name': 'Khloé Kardashian','follower_count': 112,'description': 'Reality TV personality and businesswoman','country': 'United States'},
    ...
    {'name': 'Shakira','follower_count': 79,'description': 'Musician','country': 'Colombia'},
    {'name': 'Drake','follower_count': 77,'description': 'Musician','country': 'Canada'},
    {'name': 'David Beckham','follower_count': 76,'description': 'Footballer','country': 'United Kingdom'},
    {'name': 'Billie Eilish','follower_count': 75,'description': 'Musician','country': 'United States'},
    {'name': 'LeBron James','follower_count': 74,'description': 'Basketball player','country': 'United States'},
    {'name': 'Chris Brown','follower_count': 72,'description': 'Musician','country': 'United States'},
    {'name': 'Vin Diesel','follower_count': 71,'description': 'Actor','country': 'United States'},
    {'name': 'Cardi B','follower_count': 67,'description': 'Musician','country': 'United States'},
    {'name': 'UEFA Champions League','follower_count': 66,'description': 'Club football competition','country': 'Europe'},
    {'name': 'NASA','follower_count': 65,'description': 'Space agency','country': 'United States'},
    {'name': 'Emma Watson','follower_count': 64,'description': 'Actress','country': 'United Kingdom'},
    {'name': 'Shawn Mendes','follower_count': 61,'description': 'Musician','country': 'Canada'},
    {'name': 'Virat Kohli','follower_count': 60,'description': 'Cricketer','country': 'India'},
    {'name': 'Gigi Hadid','follower_count': 59,'description': 'Model','country': 'United States'},
    {'name': 'Priyanka Chopra Jonas','follower_count': 58,'description': 'Actress and musician','country': 'India'},
    {'name': 'Ronaldinho','follower_count': 57,'description': 'Footballer','country': 'Brazil'},
    {'name': 'Maluma','follower_count': 56,'description': 'Musician','country': 'Colombia'},
    {'name': 'Camila Cabello','follower_count': 55,'description': 'Musician','country': 'Cuba'},
    {'name': 'NBA','follower_count': 54,'description': 'Club Basketball Competition','country': 'United States'}
]
...
def check_answer(guess, a_followers, b_followers):
    """Checks followers against user's guess and returns True if correct."""
